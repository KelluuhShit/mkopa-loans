    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-lg z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary">Okoa Chapaa Loans</h1>
      ...
      <section id="home" className="pt-32 pb-24 text-center bg-gradient-to-b from-background to-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-12">
            Okoa Chapaa Loans Loans helps you handle emergencies with quick approval, flexible repayment, and zero stress.
          </p>
      ...
      <section id="about" className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <h3 className="text-2xl font-semibold mb-8">About Okoa Chapaa Loans Loans</h3>
          <p className="text-lg text-gray-700 max-w-4xl mx-auto mb-16">
            We're a digital loan solution built for Kenyans. Whether it's an emergency, school fees, or business capital, Okoa Chapaa Loans has your back with fast, reliable financing you can trust.
          </p>
      ...
      <section id="how" className="py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-16">
            Getting a loan with Okoa Chapaa Loans is straightforward. Follow these four simple steps.
          </p>
            ...
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl shadow-xl">
                ...
                <p className="italic text-gray-700 mb-6">
                  "{i===0?'Okoa Chapaa Loans imenisaidia sana when things were tight. Approval ilikuwa fast, no stress kabisa!':
                     i===1?'I needed quick cash for an emergency, Okoa Chapaa Loans ilikuwa there. Very legit app.':
      ...
      <section id="apply" className="py-20 bg-primary text-white text-center">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold mb-6">Need Help Today? Okoa Chapaa Loans Has You Covered</h2>
      ...
      <footer id="contact" className="bg-primary text-white py-12">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h3 className="text-3xl font-bold mb-4">Okoa Chapaa Loans</h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-left max-w-4xl mx-auto">
            ...
            <div>
              ...
              <p>support@okoachapaaloans.co.ke</p>
              <p>+254 700 123 456</p>
              <p>Westlands, Nairobi, Kenya</p>
            </div>
          </div>
          <p className="mt-12 text-sm">
            © 2024 Okoa Chapaa Loans Loans. All rights reserved.<br/>
